...
class KoGPT2Chat(LightningModule):
    ...
    def chat(self, sent='0'):
        emo_model = tf.keras.models.load_model('model/best_model.h5')
        tok = TOKENIZER
        okt = konlpy.tag.Okt()
        tokenizer_tensor = tf.keras.preprocessing.text.Tokenizer()
